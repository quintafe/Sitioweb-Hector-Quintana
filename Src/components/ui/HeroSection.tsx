...
export default function HeroSection() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-28 left-1/2 z-10 w-full -translate-x-1/2 px-4">
        <div
        ...
        >
          <a
            href="#eventos"
            className="px-8 py-3.5 border border-warm-cream/40 text-warm-cream font-semibold text-sm uppercase tracking-wider rounded-sm hover:border-slate-400 hover:bg-slate-600/40 hover:text-white active:scale-[0.97] transition-all duration-200"
          >
            Próximos Eventos
          </a>
          <a
